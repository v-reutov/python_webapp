          ...
          gridcols: []
            ...
            gs.gridcols.push(i);
				...
				if (!styled) {
					styled = true;
					styles = [
						'.jstree-grid-cell {vertical-align: top; overflow:hidden;margin-bottom: 3px;position:relative;width: 100%;padding-left:7px; white-space: nowrap;}',
						'.jstree-grid-cell span {margin-right:0px;margin-right:0px;*display:inline;*+display:inline;white-space: nowrap;}',
						'.jstree-grid-separator {position:absolute; top:-2px; right:0; height:24px; margin-left: 0px; border-width: 0 0 0 0; *display:inline; *+display:inline; margin-right:0px;width:0px;}',
